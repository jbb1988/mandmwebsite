...
export const PAGE_SEO: Record<string, PageSEO> = {
  home: {
    ...
    ogTitle: 'Mind & Muscle | 100% Baseball Training',
    ogDescription: 'The only app built exclusively for baseball players. AI coaches for mind, muscle, and game IQ. Train smarter, recover faster, outthink every play.',
