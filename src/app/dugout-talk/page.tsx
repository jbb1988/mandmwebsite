...
export default function DugoutTalkRedirectPage() {
  ...
  const openInApp = () => {
    ...
    if (isIOS) {
      ...
      window.location.href = 'mindmuscle://dugout-talk';
    } else if (isAndroid) {
      // Android intent URL with fallback to stay on page
      window.location.href = 'intent://dugout-talk#Intent;scheme=mindmuscle;package=com.exceptionalhabit.mind_and_muscle;S.browser_fallback_url=https://www.mindandmuscle.ai/dugout-talk;end';
    } else {
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-center mb-12">
          <div className="inline-block mb-6">
            <LiquidGlass variant="blue" rounded="full" padding="none" glow={true} className="px-8 py-4">
              <div className="flex items-center gap-3">
                <MessageSquare className="w-8 h-8 text-neon-cortex-blue drop-shadow-[0_0_12px_rgba(59,130,246,0.8)]" />
                <span className="text-xl md:text-2xl font-bold">DUGOUT TALK</span>
              </div>
            </LiquidGlass>
          </div>
          ...
          <p className="text-xl sm:text-2xl text-gray-300 max-w-5xl mx-auto font-medium leading-relaxed mb-2">
            Reflect on your Daily Hit session and get personalized insights from your AI coach in Dugout Talk.
          </p>
        </div>
        ...
        <div className="lg:hidden mb-8">
          <LiquidGlass variant="blue" glow={true}>
            <div className="p-6">
              ...
              >
                Open Dugout Talk in App
              </button>
              <p className="text-center text-sm text-text-secondary mt-3">
                Already have the app? Tap to share your reflections
              </p>
            </div>
          </LiquidGlass>
        </div>
        ...
        <LiquidGlass variant="blue" className="mb-8">
          <div className="p-8">
            ...
            <p className="text-text-secondary text-center mb-6">
              Download Mind & Muscle to access Dugout Talk and share your reflections
            </p>
        ...
        <LiquidGlass variant="neutral">
          <div className="p-8">
            <h3 className="text-xl font-bold mb-4">What is Dugout Talk?</h3>
            <div className="space-y-3 text-text-secondary">
              <div className="flex items-start gap-3">
                <span className="text-neon-cortex-blue">•</span>
                <span>Your personal journal for baseball mental training</span>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-neon-cortex-blue">•</span>
                <span>Reflect on your Daily Hit sessions and track your growth</span>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-neon-cortex-blue">•</span>
                <span>Get AI-powered insights on your mental performance patterns</span>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-neon-cortex-blue">•</span>
                <span>Build your streak and develop consistent mental training habits</span>
              </div>
            </div>
          </div>
        </LiquidGlass>
