        ...
        <div className="mb-8">
          ...
          <div className="overflow-auto rounded-xl border border-white/10">
            ...
            >
              ...
              {/* QR Code Section - Bottom right corner, below/right of logo */}
              {qrCodeImage && (
                <div
                  style={{
                    position: 'absolute',
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <span style={{ color: 'white', fontSize: '9px', fontWeight: 'bold' }}>App Store</span>
                    </div>
                    <div
                      style={{
                        backgroundColor: 'black',
                    ...
                    >
                      ...
                      <span style={{ color: 'white', fontSize: '9px', fontWeight: 'bold' }}>Google Play</span>
                    </div>
                  </div>
                </div>
              )}
