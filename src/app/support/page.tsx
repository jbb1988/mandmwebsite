...
import { Mail, FileText, Shield, UserCircle, HelpCircle, Users } from 'lucide-react';
...
export default function SupportPage() {
  ...
  useEffect(() => {
    ...
    if (hash && ['contact', 'terms', 'privacy', 'coppa', 'partner-terms'].includes(hash)) {
      setActiveTab(hash);
    }
  }, []);
    ...
    <div className="min-h-screen pt-32 pb-20 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-7xl mx-auto text-center mb-12">
        ...
        <p className="text-xl text-text-secondary max-w-3xl mx-auto">
          Get help, review our policies, and understand your rights
        </p>
      </div>
    ...
    <div className="space-y-8">
      ...
      <div className="p-6 rounded-xl bg-solar-surge-orange/10 border border-solar-surge-orange/20">
        ...
        <div className="space-y-4">
          <div>
            <h4 className="font-semibold mb-1">How do I redeem my team code?</h4>
            <p className="text-sm text-text-secondary">
              Open the Mind and Muscle app, go to More {'>'} Settings {'>'} Redeem Team Code, and enter your code.
            </p>
          </div>
          <div>
          ...
          <div>
            <h4 className="font-semibold mb-1">How do I manage my subscription?</h4>
            <p className="text-sm text-text-secondary">
              Team licenses are managed through your Stripe customer portal. Check your email for a link, or contact support for assistance.
            </p>
          </div>
        </div>
      </div>
