            ...
            {[
              {
                ...
                description: 'How coaches use The Vault to assign drills, track engagement, and extend their impact',
              ...
              {
                title: 'Athlete Guide',
                description: 'Step-by-step workflow for athletes using The Vault and Swing Lab',
              ...
              {
                title: 'Parent Guide',
                description: 'What parents can see, how to support without micromanaging',
              ...
              },
              {
                ...
                description: 'Setup checklist, materials, talking points, and success metrics',
                href: '/dbat/playbook',
                icon: Building2,
                color: 'blue',
                protected: true,
              ...
              >
                <div
                  className={`h-full rounded-2xl p-6 transition-all duration-300 hover:scale-[1.02] ${
                    guide.color === 'blue'
                      ? 'border border-neon-cortex-blue/30 hover:border-neon-cortex-blue/60'
                      : 'border border-solar-surge-orange/30 hover:border-solar-surge-orange/60'
                  }`}
                  style={{
                    background: 'linear-gradient(135deg, rgba(15, 17, 35, 0.9) 0%, rgba(27, 31, 57, 0.9) 100%)',
                  }}
                >
                  ...
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    {guide.protected && (
                      <span className="text-xs px-2 py-0.5 rounded bg-white/10 text-white/60">Protected</span>
                    )}
                  </div>
